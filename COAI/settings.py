"""
Django settings for COAI project.
...
SECRET_KEY = 'django-insecure-&zy$wghts)@v2!tm=3!n(o6d0bmfku=jliq84#u$0r81utr+8%'
...
WSGI_APPLICATION = 'COAI.wsgi.application'
